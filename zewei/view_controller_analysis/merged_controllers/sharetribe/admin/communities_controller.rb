class Admin::CommunitiesController < ApplicationController
 ...
 categories_link = link_to t("admin.communities.getting_started.categories_link_text"), admin_categories_path 
 ...
 welcome_email_link = link_to t("admin.communities.getting_started.welcome_email_link_text"), edit_welcome_email_admin_community_path(@current_community) 
 instruction_texts_link = link_to t("admin.communities.getting_started.instruction_texts_link_text"), edit_text_instructions_admin_community_path(@current_community) 
 ...
 t("admin.communities.getting_started.welcome_to_your_marketplace", :name => @current_user.given_name_or_username) 
 t("admin.communities.getting_started.intro", :live_site_link => live_site_link).html_safe 
 t("admin.communities.getting_started.look_and_feel", :logo_link => logo_link).html_safe 
 t("admin.communities.getting_started.custom_domain", :contact_support_link => contact_support_link).html_safe 
 t("admin.communities.getting_started.categories_and_custom_fields", :categories_link => categories_link, :custom_fields_link => custom_fields_link, :filters_link => filters_link).html_safe 
 t("admin.communities.getting_started.order_types", :order_types_link => order_types_link).html_safe 
 if paypal_enabled 
 t("admin.communities.getting_started.payments", :payments_link => payments_link).html_safe 
 end 
 t("admin.communities.getting_started.info_texts", :about_page_link => about_page_link, :terms_of_use_link => terms_of_use_link, :privacy_policy_link => privacy_policy_link, :welcome_email_link => welcome_email_link, :instruction_texts_link => instruction_texts_link).html_safe 
 t("admin.communities.getting_started.social_media", :facebook_link => facebook_link, :twitter_link => twitter_link).html_safe 
 t("admin.communities.getting_started.analytics", :analytics_link => analytics_link).html_safe 
 t("admin.communities.getting_started.settings", :settings_link => settings_link).html_safe 
 t("admin.communities.getting_started.final_words", :invite_link => invite_link, :view_users_link => view_users_link, :view_transactions_link => view_transactions_link, :contact_support_link => contact_support_link).html_safe 
 end 
