  ...
  class Attachment < ActiveRecord::Base
    ...
    class << self
      ...
      def configuration
        @@configuration ||= Attachments.configuration
      end

      # Returns a Proc that can be used to dynamically determine styles based on the Attachment class
      #
