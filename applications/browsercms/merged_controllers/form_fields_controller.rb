  class FormFieldsController < BaseController
    ...
    def new
      @field = FormField.new(label: 'Untitled', field_type: params[:field_type], form_id: params[:form_id])
ruby_code_from_view.ruby_code_from_view do |rb_from_view|
 ...
 f.button :submit, "Save", style: 'display: none' 
    ...
    def preview
      ...
      @field = FormField.new(label: 'Untitled', name: :untitled, field_type: params[:field_type], form: @form)
ruby_code_from_view.ruby_code_from_view do |rb_from_view|
 ...
 link_to("Delete", "#", data: {path: delete_path}, class: "btn delete_field_button") 
    ...
    def create
      form = Form.find(params[:form_field].delete(:form_id))
