  ...
  module PathHelper
    ...
    def build_path_for(model_or_class_or_content_type)
      EngineAwarePathBuilder.new(model_or_class_or_content_type).build(self)
    end
