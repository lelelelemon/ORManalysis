...
module Cms
  # Attachments::Configuration exposes an interface to setup paperclip for BrowserCMS.
  #
  ...
  # the ones already defined by Paperlip itself, the Assets
  ...
  module Attachments
    ...
    Paperclip.interpolates :attachments_root do |_, _|
      strategy = Attachments::Serving.send_attachments_with
