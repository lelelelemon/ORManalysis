  module Attachments
    ...
    module Serving
      ...
      # Default is:
      #   storage = :filesystem -> Attachments::FilesystemStrategy
      def send_attachment(attachment)
        if attachment
          raise Errors::AccessDenied unless current_user.able_to_view?(attachment)
      ...
      def send_attachments_with
        Attachments::Serving.send_attachments_with
      end
      ...
      def self.send_attachments_with
        ...
        "Attachments::#{storage.to_s.classify}Strategy".constantize
      end
