...
#   works in ContentRenderingSupport. 
module Cms
  module Acts

    # Override some of the behavior defined in PageHelper so templates display correctly Rails Controllers
    module PageHelper
    ...
    module ContentPage
      ...
      def self.included(base)
        base.send :include, ContentRenderingSupport
        base.send :include, Authentication::Controller
        base.extend ClassMethods

        base.helper PageHelper
        base.helper RenderingHelper
        base.helper MenuHelper
        base.helper Acts::PageHelper
        base.helper UiElementsHelper
        base.helper PathHelper
        base.send :include, NavMenuHelper
      end
