  module Concerns
    module CanBeAddressable
      ...
      def is_addressable(options={})
        has_one_options = {as: :node, inverse_of: :node, class_name: 'SectionNode', validate: true}
        ...
        extend Concerns::Addressable::ClassMethods
        include Concerns::Addressable::NodeAccessors
        include Concerns::Addressable::MarkAsDirty
        extend Configuration::ConfigurableTemplate
    ...
    module GenericSitemapBehavior
      ...
      def assign_parent_if_needed
        unless parent || parent_id
          new_parent = Section.with_path(self.class.path).first
          ...
          unless new_parent
            ...
            section_attributes = {:name => self.class.name.demodulize.pluralize,
                                  ...
                                  :hidden => true,
                                  allow_groups: :all}
            section_parent = Section.root.first
            if section_parent
              section_attributes[:parent] = section_parent
            end
            new_parent = Section.create!(section_attributes)
          end
    ...
    module Addressable
      ...
      #
      # @return [Array<Class>] Returns all classes which inherit from Concerns::Addressable
      def self.descendants
        ObjectSpace.each_object(::Class).select { |klass| klass < Concerns::Addressable }
      end
