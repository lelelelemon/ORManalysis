  ...
  module Behaviors
    ...
    #  - Book#cover @return [Attachment]
    #  - Book#drafts @return [Array<Attachment>]
    #
    module Attaching
      ...
      module MacroMethods
        ...
        def allow_attachments
          ...
          has_many :attachments, :as => :attachable, :dependent => :destroy, :class_name => 'Attachment', :autosave => false
      ...
      module ClassMethods
        ...
        def attachments_as_of_version(version_number, attachable)
          found_versions = Attachment::Version.where(:attachable_id => attachable.id).
        ...
        def definitions_for(name)
          Attachment.definitions[self.name][name]
        end
      end
      ...
      module InstanceMethods
        ...
        def attachment_names
          Attachment.definitions[self.class.name].keys
        end
        ...
        def unassigned_attachments
          ...
          Attachment.find attachment_id_list.split(',').map(&:to_i)
        end
