  ...
  module Generators
    ...
    class ContentBlockGenerator < Rails::Generators::NamedBase
      ...
      def set_classpath
        ...
        unless namespaced?
          cms_engine_module_name = EngineAware.module_name(Rails.application.class).constantize
      ...
      def create_controller_and_views
        gsub_file File.join('app/controllers', class_path, "#{file_name.pluralize}_controller.rb"), /ApplicationController/, "ContentBlockController"
